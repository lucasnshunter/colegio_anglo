...
class SlidersControllerTest < ActionController::TestCase
  ...
  test "should create slider" do
    assert_difference('Slider.count') do
      post :create, slider: { descricao: @slider.descricao, frase: @slider.frase, link: @slider.link, texto: @slider.texto, titulo: @slider.titulo }
    end
  ...
  test "should update slider" do
    patch :update, id: @slider, slider: { descricao: @slider.descricao, frase: @slider.frase, link: @slider.link, texto: @slider.texto, titulo: @slider.titulo }
    assert_redirected_to slider_path(assigns(:slider))
  end
