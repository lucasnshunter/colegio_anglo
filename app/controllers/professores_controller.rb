class ProfessoresController < ApplicationController
  ...
  def show
     @arquivos = @professore.arquivos.all
  ...
  def destroy
    @professore.destroy
    respond_to do |format|
      format.html { redirect_to nucleo_path(@professore.nucleo_id), notice: 'Professore was successfully destroyed.' }
  ...
  private
    ...
    def professore_params
      params.require(:professore).permit(:nome, :disciplina, :descricao, :nucleo_id,:photo)
    end
end
